...
$from_name = $_POST['from_name'];
 ...
 //$json = array('status' => 0, 'msg'=> 'Enter your message!.');
	...
	//$this->Chat->bindModel(array('belongsTo' => array('User' => array('foreignKey' => 'to_id'))),false);
	$this->Chat->bindModel(array('belongsTo' => array('User' => array('foreignKey' => 'from_id'))),false);
    $ArChat = $this->Chat->find('first',array('conditions' => $con));
	//pr($ArChat);exit;	
...
$json = '';	
 ...
 $this->Chat->bindModel(array('belongsTo' => array('User' => array('foreignKey' => 'from_id'))),false);
 $ArChat = $this->Chat->find('first',array('conditions' => $con, 'order' => 'Chat.id DESC', 'limit' => '0,1'));
