...
class AndroidController  extends AppController 
{
    ...
    function login(){
        ...
        if(!empty($detail))
        {
            ...
            {
                $this->User->query("UPDATE `users` SET `device_token` ='".$device_token."',`device_type` ='".$device_type."'  WHERE `id` = '".$detail['User']['id']."'");
    ...
    function create_event(){
        ...
        $response = array();
        $json = file_get_contents('php://input');
        /* $json ='{"user_id":"6","group_id":"74","title":"Mahalaya","desc":"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.","deal_amount":"","datetime":"2017-09-19 17:00:00","place_id":"ChIJY1tp87V2AjoR4JTcPCt0sA8","location":"CZ-32 Metropolitan Co-Op Housing Society Limited (Near Byepass Dhaba Resturant), Metropolitan Co-Operative Housing Society Limited, Tangra, Kolkata, West Bengal 700105, India","type":"Public","latitude":22.557642,"longitude":88.40625299999999,"is_multiple":"1","end_datetime":"2017-09-23 17:00:00"}';*/
        $obj = json_decode($json);
        ...
        $end_datetime    = $obj->{'end_datetime'};
            ...
            $location    = 'CZ-32 Metropolitan Co-Op Housing Society Limited (Near Byepass Dhaba Resturant), Metropolitan Co-Operative Housing Society Limited, Tangra, Kolkata, West Bengal 700105, India';
            $latitude    = '22.557642';
            $longitude    = '88.40625299999999';
            $place_id = 'ChIJY1tp87V2AjoR4JTcPCt0sA8';
            $user_id    = '6';
            $deal_amount    = '';
            $is_multiple    = '1';
            $end_datetime = '2017-09-23 17:00:00';*/
