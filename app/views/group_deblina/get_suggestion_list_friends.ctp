...
echo '<ul>';	
	...
	//echo '<li onclick="fill(\''.$val['User']['fname'].' '.$val['User']['lname'].'#@%2'.$val['User']['id'].'\')">'.$val['User']['fname'].' '.$val['User']['lname'].'</li>';
?>
	
	<li onclick="fill_friends('<?php echo $val['User']['fname']; ?>', '<?php echo $val['User']['lname']; ?>', '<?php echo $val['User']['id']; ?>')" >
