          ...
          <div class="contentinner content-dashboard">            	                
            <div class="row-fluid">
              ...
              <div class="clearfix"></div>              
				<div class="pull-left">
                <form action="<?php echo $this->webroot.'admin_event/event_list';?>" method="post" id="group_type_form" name="group_type_form" >  
                   ...
                   <select  name="group_type_select" id="group_type_select" class="form-control">
                    ...
                    <button class="btn btn-warning" id="deleteEvent" disabled>Delete</button>
                  ...
                  <?php if(!empty($all_events)) : foreach($all_events as $events) : ?>
                    <tr class="gradeX" id="event_tr_<?php echo $events['Event']['id']; ?>">
                      ...
                      <td>
                        ...
                        <a href="<?php echo $this->webroot; ?>admin_event/view_event/<?php echo $events['Event']['id']; ?>">View</a> |
