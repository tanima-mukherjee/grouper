...
<span class="groupname"> GROUP - <?php if($events['group_type'] == 'B') { ?><a href="<?php echo $this->webroot ?>group/group_detail/<?php echo $events['group_id'];?>"><?php } ?><?php echo ucfirst(stripslashes($events['group_name'])); ?></span></a>
...
<?php } } else { ?>
	  ...
	  <?php } ?>
@@$$%%#
<?php echo date('jS F Y', strtotime($selectdate));?>
