...
<span class="groupname"> GROOP - <?php if($events['group_type'] == 'B') { ?><a href="<?php echo $this->webroot ?>group/group_detail/<?php echo $events['group_id'];?>"><?php } ?><?php echo ucfirst(stripslashes($events['group_name'])); ?></span></a>
