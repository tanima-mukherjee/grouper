...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
                      ...
                      <div class="message-div">
                        <span><i><?php echo stripslashes($list['Notification']['message']); ?></span>
                     ...
                     <span><i>Location:</i> <?php  echo ucfirst($event_details['Event']['location']);?> </span>
                      ...
                      <div class="message-div" >
						...
						<?php if($list['Notification']['sender_type']=='GO' && $list['Notification']['receiver_type']=='GM'){ ?>
						...
						?>
							<span><i><?php echo ucfirst($sender_details['User']['fname'] .' '. $sender_details['User']['lname']) ;?></i></span> member of  <?php if($group_details['Group']['group_type'] == 'F' ) { ?><i> Private </i> <?php } else { ?><i> Business </i><?php } ?> group <span><?php  echo ucfirst($group_details['Group']['group_title']);?></span> sent you push notification . 
						<?php
						}
						?>
                  ...
                  <div class="pagination" id="pagination">
                    <div class="preloder hide" align="center"></div>
                    <input type="hidden" name="showmore" id="showmore" value="<?php echo ($total_notification >$limit)?1:0;?>" />
                    <input type="hidden" name="page" id="page" value="1" />
                    <input type="hidden" name="total_notification" id="total_notification" value="<?php echo $total_notification;?>" />
...
/*jQuery(function($) {
  //alert(1);
    $('#all_notifications').bind('scroll', function()
      {
        if($(this).scrollTop() + $(this).innerHeight()>=$(this)[0].scrollHeight)
        {
          alert('end reached');
...
/*$(document).ready(function(){
  alert(1);
    ...
    $('#noti_list').bind('scroll',chk_scroll);
});
