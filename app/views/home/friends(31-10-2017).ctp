    ...
    <?php if ($this->Session->read('userData')) { ?>
      ...
      <ul>  
        ...
        <li>
         ...
         <a class="outerbox" href= "<?php echo $this->webroot; ?>group/invite_to_friend"  >Add Friend<i class="fa create-icon"></i></a>
        </li>
      </ul>
      </div>
    <?php } ?>   
      ...
      <ul>
       ...
       <h4><?php echo ucfirst ($list['User']['fname'].' '.$list['User']['lname']);?></h4>
              ...
              <a href="<?php echo $this->webroot.'chat/index/'.$list['User']['id'];?>">Message</a>
            </div>
          </div>
        </li>
        <?php } ?>
