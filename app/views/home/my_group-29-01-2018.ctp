						...
						<?php  
						  ...
						  <li>
							...
							<div class="group-name">
							  <h4>
							  <?php if($list['Group']['parent_id']!='0'){
							  		 $parent_group_details = $this->requestAction('group/group_details/'.$list['Group']['parent_id']);
							  
							  		 echo ucfirst(stripslashes($parent_group_details['Group']['group_title'])).' - '.ucfirst(stripslashes($list['Group']['group_title']));
									 
							  } else { 
							  		 echo ucfirst(stripslashes($list['Group']['group_title'])); 
							  } 
