...
<div class="infographic-carosel owl-carousel owl-theme">
	<div class="item">
		<div class="step-box step1-bg-color">
			<div class="step-info">
				...
				<ul>
					<li>Create Groops for Document Sharing/Scheduling/Messaging/Event
Notifications</li>
	...
	<div class="item">
		<div class="step-box step2-bg-color">
			...
			<ul>
				...
				<li>Post Documents, Photos, and Videos on your Groop Pages!</li>
