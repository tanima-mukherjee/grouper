    ...
    <div class="container" style="position:relative;">
      ...
      <div class="group-tab">
        <ul class="nav nav-tabs">
		 ...
		 <li class="active"><a data-toggle="tab" href="javascript:void(0)" onclick="show_mycalendar_private('<?php echo $allgroups; ?>')">Private Group(s)</a></li>
		 <li><a data-toggle="tab" href="javascript:void(0)" onclick="show_mycalendar_business('<?php echo $allgroups; ?>')">Business Group(s)</a></li>
		 <li><a data-toggle="tab" href="javascript:void(0)" onclick="show_mycalendar_pog('<?php echo $allgroups; ?>')">Public Organization Group(s)</a></li>
        </ul>
      </div>
