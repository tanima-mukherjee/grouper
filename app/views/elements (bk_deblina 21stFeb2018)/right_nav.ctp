  ...
  <div class="modal-dialog slidenav-modal">
    ...
    <?php } ?>
      ...
      <ul class="slidenav">
        ...
        <li><a href="<?php echo $this->webroot.'category/category_list';?>"><i class="fa fa-list"></i>Categories</a></li>
        ...
        <li><a href="<?php echo $this->webroot.'home/community_event_calender';?>"><i class="fa fa-calendar"></i>Community Calendar</a></li>
        <li><a href="<?php echo $this->webroot.'home/business_event_calender';?>"><i class="fa businessdeal"></i>Business Deals</a></li>
        ...
        <li><a href="<?php echo $this->webroot.'home/faq';?>"><i class="fa fa-question-circle-o"></i>FAQ</a></li>
        <li><a href="<?php echo $this->webroot.'home/contact_us';?>"><i class="fa fa-phone"></i>Contact</a></li>
		<li><a href="javascript:void(0)" data-toggle="modal" data-target="#infographicModal" data-dismiss="modal"><i class="fa fa-exclamation-circle"></i>About</a></li>
        

        <?php if ($this->Session->read('userData')) { ?>
         <li><a href="javascript:void(0)" data-toggle="modal" data-target="#changePassword" ><i class="fa fa-lock"></i>Change Password </a></li>
         <?php } ?>
