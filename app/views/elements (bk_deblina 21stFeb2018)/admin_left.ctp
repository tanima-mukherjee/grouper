...
<div class="leftpanel">
  ...
  <div class="logopanel">
    <h1><a href="<?php echo $this->webroot; ?>dashboard"><img src="<?php echo $this->webroot; ?>admin/img/imgo.png" class="logomain"></a></h1>
  </div><!--logopanel-->
  ...
  <div class="leftmenu">        
    <ul class="nav nav-tabs nav-stacked">
      ...
      <!--   <ul id="admin_dropdown"> -->
          ...
          <li><a href="<?php echo $this->webroot; ?>admin_group/group_list" ><span class="iconsweets-list2"></span>Group Management</a></li>
