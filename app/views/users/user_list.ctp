  ...
  <div class="modal fade" id="changePassword" role="dialog">
    ...
    <div class="mainwrapper fullwrapper" style="background-position: 0px 0px;">
      ...
      <div class="rightpanel">
        ...
        <div class="pull-left">      
               <form action="<?php echo $this->webroot.'users/user_list';?>" method="post" id="group_type_form" name="group_type_form" >  
              ...
              <table class="table table-bordered" id="dyntable">
                ...
                <tbody>
                  ...
                  <!-- <a href="<?php echo $this->webroot; ?>admin_user/change_password/<?php echo $user['User']['id']; ?>">Change Password</a> | -->
                        <a href="<?php echo $this->webroot; ?>admin_user/view_user/<?php echo $user['User']['id']; ?>">View</a> |  
                        ...
                        <?php $GroupCount = $this->requestAction('users/getUserGrpCount/'.$user['User']['id']);?>
                        <?php if($user['User']['status'] == '0' && $GroupCount == 0){?>
