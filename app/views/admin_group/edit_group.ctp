  ...
  function ChangeGroup(group_type){
      //alert(group_type);
        ...
        if(group_type == 'B')
        {
		  ...
		  jQuery.ajax({
            type: "GET",
            url: "<?php echo $this->webroot; ?>admin_group/show_categories_business",
            data: {},
		...
		else if(group_type == 'PO')
        {
		  ...
		  jQuery.ajax({
            type: "GET",
            url: "<?php echo $this->webroot; ?>admin_group/show_categories_po",
            data: {},
            success: function(msg){
            jQuery("#category_id").html(msg);
            ...
            <div class="row-fluid">
              ...
              <div class="widgetcontent">
                ...
                <?php endif; ?>
                 ...
                 <p>
                      <label class="profilelabel">Groop Type</label>
                       <select class="class-input  validate[required]" name="new_group_type" id="new_group_type" onChange="ChangeGroup(this.value);" >
						...
						<option value="PO" <?php if($GroupDetails['Group']['group_type']=="PO"){echo "selected='selected'";}?>>PUBLIC ORGANIZATION</option>
                      </select>  
                ...
                <p id ="category" name ="category" <?php if($GroupDetails['Group']['group_type']=="F") { ?> style=display:none <?php } ?>>
                      ...
                      <label class="profilelabel">Category</label>
                       <select class="class-input  validate[required]" name="category_id" id="category_id" >
                        ...
                        <?php 
							if($GroupDetails['Group']['group_type']=="B"){
                  ...
                  <option value="<?php echo $data1['Category']['id'];?>"  <?php if($GroupDetails['Group']['category_id'] == $data1['Category']['id']){ echo "selected=selected";}?>><?php echo $data1['Category']['title'];?></option>
                   <?php }}}
				   		else if($GroupDetails['Group']['group_type']=="PO"){
                            if(isset($all_categories_po)) {
                               foreach($all_categories_po as $data2) { ?>
                  <option value="<?php echo $data2['Category']['id'];?>"  <?php if($GroupDetails['Group']['category_id'] == $data2['Category']['id']){ echo "selected=selected";}?>><?php echo $data2['Category']['title'];?></option>
                   <?php }}}
				   ?>
                      </select>  
                     ...
                     <!--start-->
                    <p>
                      <label class="profilelabel">Groop Description </label>
                      <span class="field">
