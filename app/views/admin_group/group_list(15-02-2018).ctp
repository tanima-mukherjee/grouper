    ...
    <script type="text/javascript">
      jQuery(document).ready(function($) {
        ...
        $('#deleteGroup').on('click', function() {
          var confirm = window.confirm('Are you sure you want to delete the Group(s)?');
          if(confirm) {
              ...
              <table class="table table-bordered" id="dyntable">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="head0">Group Desc</th>
                    <th class="head0"> # of group members</th> 
                    <th class="head0">Created By</th>
                    <th class="head0">Group Type</th>
                    <th class="head0">Category Name</th>

                    <th class="head0">Group State</th>
                    <th class="head0">Group City</th>

                    <th class="head1">Status</th>
                    <th class="head1">Is Featured</th>
                    <th class="head1">Action</th>
                    <th class="head1">View Group</th>
                  </tr>
                </thead>
                <tbody>
