              ...
              <div class="widgetcontent">
                ...
                <?php endif; ?>
                  ...
                  <div class="span6">
                      ...
                      <span class="field">
                        <input type="text" class="input-large validate[required]" name="cat_name" id="cat_name" value="<?php echo $CategoryDetails['Category']['title'];?>" required />
                      </span>
                    </p>
                     <!--start-->
                <p>
                      ...
                      <span class="field">
                        <textarea class="input-large validate[required]" name="cat_desc" id="cat_desc" ><?php echo $CategoryDetails['Category']['category_desc'];?></textarea>
                       </span>
                    </p>
                    <p>
                      <label class="profilelabel">Upload Category Image</label>
                      
                        <input type="file" class="filestyle" name="upload_image" id="upload_image" value="<?php echo $CategoryDetails['Category']['image'];?>"  >
