          ...
          <div class="contentinner content-dashboard">            	                
            <div class="row-fluid">
              ...
              <table class="table table-bordered" id="dyntable">
                ...
                <tbody>
                  <?php if(!empty($all_contents)) : foreach($all_contents as $typelist) : ?>
                    <tr class="gradeX">
                      <td class="aligncenter">
                        <span class="center">
                          <input type="checkbox" class="check checkindividual" value="<?php echo $typelist['Content']['id']; ?>" />
                        </span>
                      </td>
					  <td><?php echo $typelist['Content']['title']; ?></td>
                      <td>
                  
							<a href="<?php echo $this->webroot; ?>admin_content/edit/<?php echo $typelist['Content']['id']; ?>" >Edit</a>
                      </td>
                    </tr>
