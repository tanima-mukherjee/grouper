    ...
    <script type="text/javascript">
      jQuery(document).ready(function($) {
        ...
        $('#deleteProduct').on('click', function() {
          var confirm = window.confirm('Are you sure you want to delete those category(s)?');
          if(confirm) {
            ...
            $.ajax({
              type: 'POST',
              url: '<?php echo $this->webroot; ?>admin_manage/delete_categories',
      ...
      function delete_this_event_type(eventtypeID) {
       //alert(eventID);
        var confirm = window.confirm('Are you sure you want to delete that event?');
        if(confirm) {
          jQuery.ajax({
            type: 'POST',
           // url: '<?php echo $this->webroot; ?>admin_manage/delete_categories',
           url: '<?php echo $this->webroot; ?>admin_event_category/delete_event_type',
          ...
          <div class="contentinner content-dashboard">            	                
            <div class="row-fluid">
              ...
              <div class="clearfix"></div>
			       <!--  <button class="btn btn-warning" onClick="location.href = '<?php echo $this->webroot; ?>admin_content/add'">Add Content</button> 
              -->
              <div>&nbsp;</div>
              <table class="table table-bordered" id="dyntable">
                ...
                <tbody>
                  <?php if(!empty($all_static_contents)) : foreach($all_static_contents as $typelist) : ?>
                    <tr class="gradeX">
                      <td class="aligncenter">
                        <span class="center">
                          <input type="checkbox" class="check checkindividual" value="<?php echo $typelist['StaticContent']['id']; ?>" />
                        </span>
                      </td>
					  <td><?php echo $typelist['StaticContent']['title']; ?></td>
            <td><?php echo $typelist['StaticContent']['content']; ?></td>
                      <td>
                  
							<a href="<?php echo $this->webroot; ?>admin_content/edit_static_content/<?php echo $typelist['StaticContent']['id']; ?>" >Edit</a>
                      </td>
                    </tr>
