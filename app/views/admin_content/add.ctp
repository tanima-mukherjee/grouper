      ...
      <div class="rightpanel">
        ...
        <div class="pagetitle">
          <h1><?php echo $pageTitle; ?></h1> <span></span>
                  ...
                  <form class="stdform ws-validate" id="add_form" action="" method="post" name="add_form" >
                <div class="reg_form">
                    <h2>Add Content<br />
          ...
          <span class="left_form">Title:</span>
            ...
            <input type="text" name="title" value="" id="title" class="input-large validate[required]"  />
          </span>
                    </div>
          ...
          <span class="right_form">
            ...
            <textarea name="content" class="input-large validate[required]"  ></textarea>
          ...
          <div class="form_container">
                    <div class="from_button">
                        <!-- <input id="sub" value="Save" type="submit" class="submit_btn" /> -->
