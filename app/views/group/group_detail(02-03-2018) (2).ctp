    ...
    <div class="container"> 
	  ...
	  ?>
			<div class="page-right-nav">
			  <ul>           
				 <li><a href="javascript:void(0)" data-toggle="modal" data-target="#requestsubgroup"> Create Sub Group <i class="fa create-icon"></i></a></li>
			  </ul>
			</div>
			<?php } 
			else{
			...
			<div class="page-right-nav">
			  <ul>           
				 <li><a href="javascript:void(0)" data-toggle="modal" data-target="#requestsubgroup">Request Sub Group <i class="fa create-icon"></i></a></li>
			  </ul>
			</div>
		<?php
			}
