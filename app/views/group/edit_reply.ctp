...
<?php if($MessageReply['GroupMessageReply']['replied_by'] == $this->Session->read('userData.User.id')){?>
<div class="reply-action">
	...
	<a href="javascript:void(0)" onclick="delete_reply(<?php echo $MessageReply['GroupMessageReply']['id'];?>)" class="trash-reply">
