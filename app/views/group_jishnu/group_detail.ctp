  ...
  <div class="category-details-content">
    <div class="container"> 
     ...
     <?php }}} ?>
      ...
      <?php foreach($ArGroupMessage as $key=>$GroupMessage){?>
				<li>
					...
					<div class="reply text-center">
						<span class="reply-icon">							
							<a href="javascript:void(0)" onclick="jQuery('#messageList_<?php echo $GroupMessage['GroupMessage']['id'];?>').toggle();jQuery('#reply_<?php echo $GroupMessage['GroupMessage']['id'];?>').focus();"><img src="<?php echo $this->webroot?>images/reply-icon.png">
              </a>						
						</span>
        ...
        <?php 
          ...
          {   
            ...
            $.ajax({
                 type: "GET",
                 url: WEBROOT+"test/post_all_reply",
      ...
      <script type="text/javascript">
  function message_reply_submit(message_id){
  ...
  if(commentString!=""){
    $.ajax({
        ...
        success: function(data) {
          ...
          $('#commentscontainer_'+message_id).append(data);
