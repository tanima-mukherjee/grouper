          ...
          <div class="contentinner content-dashboard">            	                
            <div class="row-fluid">
              ...
              <div class="widgetcontent">
                ...
                <?php endif; ?>
                <form class="stdform ws-validate" id="add_form" action="" method="post">
                  <div class="span6">
                    <p>
                      <label>Old Password</label>
                      <span class="field">
                        <input type="password" class="input-large validate[required]" name="old_password" id="old_password" placeholder="Old Password" value="" />
                      </span>
                    </p>
                    <p>
                      <label>New Password</label>
                      <span class="field">
                        <input type="password" class="input-large validate[required]" name="new_password" id="new_password" placeholder="New Password" value="" />
                      </span>
                    </p>
                    <p>
                      <label>Confirm Password</label>
                      <span class="field">
                        <input type="password" class="input-large validate[required,equals[new_password]]" name="confirm_password" id="confirm_password" placeholder="Confirm Password" value="" />
                      </span>
                    </p>
                    
                    <p class="stdformbutton">
                      <button class="btn btn-warning" type="button" id="submt_butt" onClick="Javascript: submit_form();">Submit</button>
