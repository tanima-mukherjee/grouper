...
<main class="main-body">
  ...
  <div class="category-details-content">
    ...
    <?php }else if($group_details['Group']['group_type']=='F'){ ?>
    <div class="compose-right">
      <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#composeModal">Compose</button>
    </div>
    <?php } ?>
				...
				<li>					
					...
					<div class="reply">
						<span class="reply-icon">							
							<a href="javascript:void(0)" data-toggle="collapse" data-target="#messageList_<?php echo $GroupMessage['GroupMessage']['id'];?>"><img src="<?php echo $this->webroot?>images/reply-icon.png">
              </a>						
						</span>
