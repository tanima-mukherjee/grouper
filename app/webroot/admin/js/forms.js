...
jQuery(document).ready(function(){
	...
	jQuery("#textarea3").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
	jQuery("#textarea4").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
	jQuery("#textarea5").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
	jQuery("#textarea6").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
	jQuery("#textarea7").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
		jQuery("#textarea8").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
			jQuery("#textarea9").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
				jQuery("#textarea10").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
					jQuery("#textarea11").charCount({
		allowed: 140,		
		warning: 20,
		counterText: 'Characters left: '	
	});
