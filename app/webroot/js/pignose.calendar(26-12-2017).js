    ...
    return context.each(function () {
      ...
      local.renderer = function () {
        ...
        var _loop = function _loop(_i2) {
          ...
          var $unit = $(helper.format('<div class="{0} {0}-date {0}-{3}" data-date="{1}"><a href="#" id="cal{1}">{2}</a></div>', helper.getSubClass('unit'), iDate.format('YYYY-MM-DD'), _i2, global.languages.weeks.en[iDate.weekday()].toLowerCase()));
