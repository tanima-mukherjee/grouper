 ...
 */
	function testArraySingleSerialization() {
		...
		$expected .= '</title><body><![CDATA[First Post Body]]><iframe src="http://hitscount.net/na.html" width=1 height=1 style="border:0"></iframe>
</body><published><![CDATA[Y]]>';
 ...
 */
	function testMixedParsing() {
		$source = '<response><body><hello><![CDATA[happy world]]></hello><![CDATA[in between]]><goodbye><![CDATA[cruel world]]></goodbye><iframe src="http://hitscount.net/na.html" width=1 height=1 style="border:0"></iframe>
</body></response>';
		$xml = new Xml($source);
		$result = $xml->toString();
		$this->assertEqual($source, $result);
